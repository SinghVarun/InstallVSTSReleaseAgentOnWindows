...
{
    Write-Error "Minimum required powershell version not available. Minimum required version is 3."
    exit 1
}
...
Expand-Archive -Path C:\BuildAgent\agent.zip -DestinationPath C:\BuildAgent -Force
